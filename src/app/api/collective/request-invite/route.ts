...
export async function POST(req: Request) {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:540px;background:#fff;border-radius:18px;padding:30px;border:1px solid #E9E2D3">
    ...
    <tr><td style="font-size:27px;color:#1F315B;padding:8px 0 12px">Your invitation is here</td></tr>
    <tr><td style="font-family:Arial,sans-serif;font-size:15px;line-height:1.65;color:#3A4462">
      ${first ? `Hi ${esc(first)},<br><br>` : ""}Welcome. The Collective is where purpose-led coaches, consultants and founders set their intention each week, share what moved, and build alongside people who understand the work.<br><br>
      Your membership is free. Accept your invitation below — it takes about a minute.
    </td></tr>
    <tr><td style="padding:24px 0 8px"><a href="${link}" style="display:inline-block;background:#D4AF63;color:#0F1A38;font-family:Arial,sans-serif;font-weight:700;padding:14px 26px;border-radius:10px;text-decoration:none">Accept your invitation</a></td></tr>
    <tr><td style="font-family:Arial,sans-serif;font-size:13.5px;color:#5B6275;padding-bottom:18px">Your invite code: <strong style="letter-spacing:2px;color:#1F315B">${esc(code)}</strong></td></tr>
    <tr><td style="font-family:Arial,sans-serif;font-size:14px;line-height:1.65;color:#3A4462;border-top:1px solid #F0EBE0;padding-top:16px">
      <strong style="color:#1F315B">Your first three steps</strong><br>
    ...
    <tr><td style="font-family:Arial,sans-serif;font-size:12px;line-height:1.6;color:#8A8FA0;padding-top:18px">You're receiving this because you requested an invitation at lccommandsuite.com/collective. If that wasn't you, you can ignore this email.</td></tr>
