...
const assessments = [
  {
    ...
    sections: ["Business Model", "Offers", "Marketing & Sales", "Operations", "Financials"],
    benefits: [
  ...
  },
  {
    ...
    sections: ["Core Identity", "Origin Story", "Calling & Purpose", "Values & Standards", "Beliefs & Worldview"],
    benefits: [
