    ...
    <div className="py-8 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        ...
        <Card className="border-[#5E3B6C]/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm text-[#B9A9A9]">Positioning</span>
        ...
        <Card className="border-[#2E7C83]/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm text-[#B9A9A9]">Audience</span>
        ...
        <Card className="border-[#D4AF63]/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm text-[#B9A9A9]">Messaging</span>
        ...
        <Card className="border-[#1F315B]/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm text-[#B9A9A9]">Channels</span>
              <TrendingUp className="w-5 h-5 text-[#1F315B]" />
            </div>
            <div className="text-3xl font-bold text-[#1F315B] dark:text-[#F6F1E8] mb-2">
              {planHealth.channels}%
            </div>
