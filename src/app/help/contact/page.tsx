    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#D4AF63]/20 mb-4">
          <LifeBuoy className="w-8 h-8 text-[#D4AF63]" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="p-6 text-center">
            <div className="w-12 h-12 rounded-full bg-[#1F315B]/10 flex items-center justify-center mx-auto mb-4">
              <Mail className="w-6 h-6 text-[#1F315B] dark:text-[#F6F1E8]" />
            </div>
            <h3 className="font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-2">Email Us</h3>
            <p className="text-sm text-[#5E3B6C] dark:text-[#CDBED6] mb-3">
              Best for detailed questions
            </p>
            <a 
              href="mailto:support@lifecharter.architecture"
              className="text-[#D4AF63] hover:underline font-medium"
            >
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="p-6 text-center">
            <div className="w-12 h-12 rounded-full bg-[#5E3B6C]/10 flex items-center justify-center mx-auto mb-4">
              <MessageCircle className="w-6 h-6 text-[#5E3B6C] dark:text-[#CDBED6]" />
            </div>
            <h3 className="font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-2">Live Chat</h3>
            <p className="text-sm text-[#5E3B6C] dark:text-[#CDBED6] mb-3">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="p-6 text-center">
            <div className="w-12 h-12 rounded-full bg-[#D4AF63]/10 flex items-center justify-center mx-auto mb-4">
              <Video className="w-6 h-6 text-[#D4AF63]" />
            </div>
            <h3 className="font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-2">Schedule a Call</h3>
            <p className="text-sm text-[#5E3B6C] dark:text-[#CDBED6] mb-3">
      ...
      <div className="bg-gradient-to-r from-[#1F315B] to-[#5E3B6C] rounded-xl p-6 text-[#F6F1E8]">
        <div className="flex items-center gap-4">
          <Clock className="w-8 h-8 text-[#D4AF63]" />
          <div>
        ...
        <CardContent>
          {submitSuccess ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-2">
                Request Submitted!
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-2 rounded-lg border border-[#1F315B]/20 bg-white dark:bg-[#1A1A2E] text-[#1F315B] dark:text-[#F6F1E8] focus:outline-none focus:ring-2 focus:ring-[#D4AF63]/50"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-[#5E3B6C] dark:text-[#CDBED6]">
                ...
                <li>• Visit our <a href="/help/12-domain-alignment" className="text-[#D4AF63] hover:underline">Help Center</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-3 flex items-center gap-2">
                <Phone className="w-5 h-5 text-[#D4AF63]" />
                Emergency Contact
              </h4>
              <p className="text-[#5E3B6C] dark:text-[#CDBED6] mb-2">
      ...
      {/* Office Hours */}
      <div className="text-center py-8 border-t border-[#1F315B]/10">
        <h3 className="font-semibold text-[#1F315B] dark:text-[#F6F1E8] mb-4">
          Our Support Hours
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="p-4 bg-[#1F315B]/5 dark:bg-[#CDBED6]/10 rounded-lg">
            <p className="font-medium text-[#1F315B] dark:text-[#F6F1E8]">Monday - Friday</p>
            <p className="text-[#5E3B6C] dark:text-[#CDBED6]">9:00 AM - 5:00 PM MT</p>
          </div>
          <div className="p-4 bg-[#1F315B]/5 dark:bg-[#CDBED6]/10 rounded-lg">
            <p className="font-medium text-[#1F315B] dark:text-[#F6F1E8]">Saturday</p>
            <p className="text-[#5E3B6C] dark:text-[#CDBED6]">Email only</p>
          </div>
          <div className="p-4 bg-[#1F315B]/5 dark:bg-[#CDBED6]/10 rounded-lg">
            <p className="font-medium text-[#1F315B] dark:text-[#F6F1E8]">Sunday</p>
            <p className="text-[#5E3B6C] dark:text-[#CDBED6]">Closed</p>
          </div>
        </div>
        <p className="text-sm text-[#B9A9A9] mt-4">
