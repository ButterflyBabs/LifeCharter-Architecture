        ...
        <CardContent>
          ...
          <ul className="space-y-3 text-[#7b6b8d] dark:text-[#e8e4f0]">
            <li className="flex items-start gap-3">
              ...
              <span><strong className="text-[#1a2b4a] dark:text-[#F8F5F0]">Quarterly reassessments</strong> track your progress</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-[#c9a227] mt-2 flex-shrink-0"></span>
              <span><strong className="text-[#1a2b4a] dark:text-[#F8F5F0]">Unified Memory</strong> remembers your journey, so you&apos;re not starting from scratch</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-[#c9a227] mt-2 flex-shrink-0"></span>
              <span><strong className="text-[#1a2b4a] dark:text-[#F8F5F0]">AI-powered insights</strong> suggest your next best moves based on your current scores</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-[#c9a227] mt-2 flex-shrink-0"></span>
              <span><strong className="text-[#1a2b4a] dark:text-[#F8F5F0]">Action items</strong> are automatically generated for your lowest-scoring domains</span>
            </li>
          </ul>
