...
const PUBLIC_APIS = [
  ...
  "/api/admin/checkout-verify", // one-time verification, secured by its own x-setup-secret check against app_settings — delete this route (and this line) once it's been run
