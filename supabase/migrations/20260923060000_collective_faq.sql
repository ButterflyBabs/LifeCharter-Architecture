...
select * from (values
  ...
  ('Getting started', 'How do I join a program channel?',
   E'Open the join link for that program, choose "Already a member", sign in, and enter the program''s invite code. The channel appears in your sidebar right away.\n\nIf you don''t have the link or code, message an admin.', 30),
  ('Getting started', 'Why can''t I see some programs?',
   'Program channels are private — you only see the ones you''ve joined. The "Explore LifeCharter" cards at the bottom of Home show other programs you might like.', 40),

  ('Posting & conversation', 'Where should I post?',
   E'Each pathway has a purpose:\n• Introduce Yourself — say hello\n• Ask the Collective — questions and support\n• Wins & Aligned Action — celebrate progress, big or small\n• This Week''s Intention — name what you''re aligning with\n• Connect & Collaborate — find the people you need\n\nPathways marked as announcements are for LifeCharter updates, so you''ll see them without a post box.', 10),
  ...
  ('Your account', 'How do I leave a program channel?',
